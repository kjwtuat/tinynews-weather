...
1. 데이터를 종합 분석하여 다음 4가지 파트로 날씨 대본을 나누어 작성하세요. (반드시 4개의 배열 요소로 출력)
   ...
   - 파트 3: "주요 도시 날씨" (입력 데이터 2에 있는 서울, 대전, 대구, 부산, 광주, 제주의 최고/최저 기온 및 습도를 구어체로 아주 자연스럽게 상세 브리핑)
